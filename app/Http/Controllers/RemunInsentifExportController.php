...
use App\Exports\RemunInsentifRekapExport;
...
class RemunInsentifExportController extends Controller
{
    ...
    public function recap(Request $request)
    {
        ...
        // Return
        return Excel::download(new RemunInsentifRekapExport($remun_insentif), 'Rekap Remun Insentif ('.$tahun.' Triwulan '.$triwulan.').xlsx');
    }
}