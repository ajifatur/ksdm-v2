...
<body>
    <div id="title">
        DAFTAR PERHITUNGAN PEMBAYARAN {{ strtoupper($jenis->nama) }} {{ $status == 1 ? 'PNS' : 'PPPK'}} UNIVERSITAS NEGERI SEMARANG<br>
        BULAN {{ strtoupper(\Ajifatur\Helpers\DateTimeExt::month($bulan)) }} {{ $tahun }}
    </div>
    <table style="width: 100%" id="data">
        ...
        <tfoot>
            ...
            <tr id="sign">
                <td colspan="11" height="80" valign="top">
