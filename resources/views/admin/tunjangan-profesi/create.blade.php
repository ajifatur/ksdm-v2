...
@section('title', 'Tambah Pengaktifan Serdos')

@section('content')

<div class="d-sm-flex justify-content-between align-items-center mb-3">
    <h1 class="h3 mb-0">Tambah Pengaktifan Serdos</h1>
</div>
<div class="row">
	<div class="col-12">
        <div class="card">
            <div class="card-body">
                ...
                @endif
                <form method="post" action="{{ route('admin.tunjangan-profesi.store') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
